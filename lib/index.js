...
exports.create = function(opt) {
  return __awaiter(void 0, void 0, void 0, function() {
    var codesignUrl, dirName, fileName, path, icon, fontSize, ex, mat, iconCtx, _a, filePath, componentPath
    return __generator(this, function(_b) {
      switch (_b.label) {
        case 0:
          ;(codesignUrl = opt.codesignUrl),
            (dirName = opt.dirName),
          ...
          if (!codesignUrl) return [3 /*break*/, 2]
          return [4 /*yield*/, ex.getIconfontContentByDown(codesignUrl)]
        case 1:
          _a = _b.sent()
          return [3 /*break*/, 4]
        case 2:
          return [4 /*yield*/, ex.getIconfontContent()]
        case 3:
          _a = _b.sent()
          _b.label = 4
        case 4:
